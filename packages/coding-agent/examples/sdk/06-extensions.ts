 ...
 * - ~/.storoslop/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.storoslop/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.storoslop/agent/extensions/ or .storoslop/extensions/
