...
export const launchHelp = {
	...
	flags: {
		...
		"from-claude": Flags.boolean({ description: "Import a Claude Code session into storoslop" }),
		"from-codex": Flags.boolean({ description: "Import a Codex session into storoslop" }),
	...
	examples: [
		...
		`# Export a session file to HTML\n  ${APP_NAME} --export ~/.storoslop/agent/sessions/--path--/session.jsonl`,
	],
