...
export function getExtraHelpText(): string {
  ...
  Use \`storoslop --profile <name> --alias <command>\` to create a shell shortcut for a profile
...
${chalk.bold("Useful Commands:")}
  storoslop agents unpack           - Export bundled subagents to ~/.storoslop/agent/agents (default)
  storoslop agents unpack --project - Export bundled subagents to ./.storoslop/agents`;
}
