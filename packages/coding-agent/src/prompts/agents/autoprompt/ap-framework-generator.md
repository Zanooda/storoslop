...
description: autoprompt L3 framework author: write a new per-framework skill template for a genuinely new framework decision
---
...
## Role
L3 framework author: write a new per-framework skill template for a genuinely new framework decision.
