---
name: ap-sweeper
description: autoprompt L3/L4 sweep leaf: re-verify and return each roadmap item to acceptance during convergence
---
...
## Role
L3/L4 sweep leaf: re-verify and return each roadmap item to acceptance during convergence.
