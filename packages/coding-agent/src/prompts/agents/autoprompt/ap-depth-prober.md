...
description: autoprompt L4 leaf: issue-derived RED repro and >=2 competing root-cause hypotheses for a debug item
---
...
## Role
L4 leaf: issue-derived RED repro and >=2 competing root-cause hypotheses for a debug item.
