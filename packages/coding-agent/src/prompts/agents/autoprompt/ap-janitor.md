---
name: ap-janitor
description: autoprompt L4 janitor: final cleanup of a completed run within the governance root only; RUNS ONLY WHEN ENABLED
---
...
## Role
L4 janitor: final cleanup of a completed run within the governance root only; RUNS ONLY WHEN ENABLED.
