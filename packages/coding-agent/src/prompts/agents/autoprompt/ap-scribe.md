---
name: ap-scribe
description: autoprompt L3 scribe: record run state and verdicts into the governance ledger, append-only
---
...
## Role
L3 scribe: record run state and verdicts into the governance ledger, append-only.
