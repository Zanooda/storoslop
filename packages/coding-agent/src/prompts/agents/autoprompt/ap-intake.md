---
name: ap-intake
description: autoprompt legacy ingestion: restate a legacy resume or intake request into the current run contract; do not start a new run
---
...
## Role
legacy ingestion: restate a legacy resume or intake request into the current run contract; do not start a new run.
