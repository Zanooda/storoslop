...
description: autoprompt L1 build coordinator: dispatch implementation lanes per ROADMAP dependencies; never implement
---
...
## Role
L1 build coordinator: dispatch implementation lanes per ROADMAP dependencies; never implement.
