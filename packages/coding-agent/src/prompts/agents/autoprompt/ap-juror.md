---
name: ap-juror
description: autoprompt L4 juror: decide done vs needs-another-round for the current candidate
---
...
## Role
L4 juror: decide done vs needs-another-round for the current candidate.
