...
description: autoprompt diagnostic capability probe: prove RUN, READ, and WRITE against a disposable scratch path
---
...
## Role
diagnostic capability probe: prove RUN, READ, and WRITE against a disposable scratch path.
