...
description: autoprompt L4 framework validator: approve or reject a framework/tool decision against repository reality
---
...
## Role
L4 framework validator: approve or reject a framework/tool decision against repository reality.
