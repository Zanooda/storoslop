...
description: autoprompt diagnostic: resolve which execution harness the run actually runs under; never claim a real environment exists when basic feasibility did not pass
---
...
## Role
diagnostic: resolve which execution harness the run actually runs under; never claim a real environment exists when basic feasibility did not pass.
