...
description: autoprompt L4 goal checker: final acceptance against the exact mission; render final accepted or failed status
---
...
## Role
L4 goal checker: final acceptance against the exact mission; render final accepted or failed status.
