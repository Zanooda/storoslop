---
name: ap-planner
description: autoprompt L3 conditional G1 planner: plan in real detail only for debug/depth-lock work, an explicit unresolved design fork, or a roadmap item marked requiresDetailedPlan
---
...
## Role
L3 conditional G1 planner: plan in real detail only for debug/depth-lock work, an explicit unresolved design fork, or a roadmap item marked requiresDetailedPlan.
