...
description: autoprompt L1 convergence coordinator: drive convergence, janitor runs, and ledger-complete DONE until no open items remain
---
...
## Role
L1 convergence coordinator: drive convergence, janitor runs, and ledger-complete DONE until no open items remain.
