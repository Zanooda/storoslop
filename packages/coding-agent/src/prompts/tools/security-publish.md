Publish current storoslop-native security scan's canonical result.
...
Tool: validates, fingerprints, assigns storoslop-owned IDs, writes canonical security store, creates SARIF.
