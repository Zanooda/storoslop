...
mkdir -p "$BINARY_DIR"
cp packages/coding-agent/dist/storoslop "$BINARY_DIR/storoslop"
smoke_cli "$BINARY_DIR/storoslop"
...
(
   ...
   smoke_cli "$BUN_INSTALL/bin/storoslop"
)
...
(
   ...
   smoke_cli ./node_modules/.bin/storoslop
)
