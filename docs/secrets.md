...
| Level   | Path                       | Purpose                     |
| ------- | -------------------------- | --------------------------- |
| Global  | `~/.storoslop/agent/secrets.yml` | Secrets across all projects |
| Project | `<cwd>/.storoslop/secrets.yml`   | Project-specific secrets    |
