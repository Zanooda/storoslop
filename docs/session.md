...
```text
~/.storoslop/agent/sessions/<encoded-cwd>/<timestamp>_<sessionId>.jsonl
```
...
```text
~/.storoslop/agent/blobs/<sha256>
```

Terminal breadcrumb files are written under:

```text
~/.storoslop/agent/terminal-sessions/<terminal-id>
```
