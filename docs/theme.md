...
- default: `~/.storoslop/agent/themes`
...
- default agent dir: `~/.storoslop/agent`
- effective default file: `~/.storoslop/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.storoslop/agent/themes/my-theme.json`.
